...
CREATE INDEX "idx_orders_org_created_id" ON "orders" USING btree ("org_id" uuid_ops,"created_at" DESC NULLS FIRST timestamptz_ops,"id" DESC NULLS FIRST uuid_ops);--> statement-breakpoint
...
CREATE INDEX "idx_verifications_org_created_id" ON "verifications" USING btree ("org_id" uuid_ops,"created_at" DESC NULLS FIRST timestamptz_ops,"id" DESC NULLS FIRST uuid_ops);--> statement-breakpoint
